...
The Trunk project operates an open contributor model where anyone is
...
The following applies to code changes to the Trunk project, and is not to be
confused with overall Trunk Network Protocol consensus changes.

Whether a pull request is merged into Trunk rests with the project merge
...
Patches that change Trunk consensus rules are considerably more involved than
...
Where a patch set proposes to change the Trunk consensus, it must have been
...
The project leader is the release manager for each Trunk release.
