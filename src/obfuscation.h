...
static const CAmount OBFUSCATION_POOL_MAX = (2999.99 * COIN);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 TRO - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of trunk.
