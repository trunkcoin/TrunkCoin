...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Trunk trunk-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  trunk-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trunk transaction") + "\n" +
                               "  trunk-tx [options] -create [commands]   " + _("Create hex-encoded trunk transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded trunk transaction
