...
/* Trunk GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Trunk"
#define QAPP_ORG_DOMAIN "trunk.org"
#define QAPP_APP_NAME_DEFAULT "Trunk-Qt"
#define QAPP_APP_NAME_TESTNET "Trunk-Qt-testnet"
