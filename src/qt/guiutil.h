...
/** Utility functions used by the Trunk Qt UI.
 */
namespace GUIUtil
{
...
// Render Trunk addresses in monospace font
...
// Parse "trunk:" URI into recipient object, return true on successful parsing
