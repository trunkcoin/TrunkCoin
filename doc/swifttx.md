...
This mechanism has been integrated into Bitcore-Node-Trunk which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Trunk-Project/insight-api-trunk#web-socket-api](https://github.com/Trunk-Project/insight-api-trunk#web-socket-api) 
* API: [https://github.com/Trunk-Project/insight-api-trunk#swifttx-transactions](https://github.com/Trunk-Project/insight-api-trunk#swifttx-transactions) 
...
By default, the Trunk daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Trunk daemon:
