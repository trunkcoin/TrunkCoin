...
In order to support loading of multiple wallets in trunk-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trunk.cpp.
...
Changes to trunk.cpp
----------------------
trunk.cpp is the entry point into trunk-qt, and as such, will require some minor modifications to provide hooks for
