...
RESOURCES += src/qt/trunk.qrc src/qt/trunk_locale.qrc

TRANSLATIONS += src/qt/locale/trunk_bg.ts \
                src/qt/locale/trunk_de.ts \
                src/qt/locale/trunk_en.ts \
                src/qt/locale/trunk_es.ts \
                src/qt/locale/trunk_fi.ts \
                src/qt/locale/trunk_fr.ts \
                src/qt/locale/trunk_it.ts \
                src/qt/locale/trunk_ja.ts \
                src/qt/locale/trunk_pl.ts \
                src/qt/locale/trunk_pt.ts \
                src/qt/locale/trunk_ru.ts \
                src/qt/locale/trunk_sk.ts \
                src/qt/locale/trunk_sv.ts \
                src/qt/locale/trunk_vi.ts \
                src/qt/locale/trunk_zh_CN.ts \
                src/qt/locale/trunk_zh_TW.ts
