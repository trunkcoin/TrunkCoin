...
#   c) node1 mines 32 blocks, so now node 0 has 60001tro, node 1 has 4250tro, node2 has none.
#   d) node0 sends 601 tro to node2, in two transactions (301 tro, then 300 tro).
